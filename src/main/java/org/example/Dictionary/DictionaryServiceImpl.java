...
public class DictionaryServiceImpl implements DictionaryService {
    ...
    /** {@inheritDoc} */
    @Override
    public List<Word> searchWords(long userId, String searchTerm) throws SQLException {
        return new ArrayList<>();
    }

    /** {@inheritDoc} */
    @Override
    public int getWordCount(long userId) throws SQLException {
        return 0;
    }

    /** {@inheritDoc} */
    @Override
    public int getWordCountByPriority(long userId, int priority) throws SQLException {
        return 0;
    }

    /** {@inheritDoc} */
    @Override
    public List<Word> getWordsByCategory(long userId, String category) throws SQLException {
        return new ArrayList<>();
    }

    /** {@inheritDoc} */
    @Override
    public List<String> getAllCategories(long userId) throws SQLException {
        return new ArrayList<>();
    }

    /** {@inheritDoc} */
    @Override
    public List<Word> getWordsForReview(long userId) throws SQLException {
        return new ArrayList<>();
    }
}