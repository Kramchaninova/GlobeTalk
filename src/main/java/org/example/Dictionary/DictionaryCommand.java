...
public class DictionaryCommand {
    ...
    private static final String ADD_WORD_INSTRUCTIONS =
            "📝 *Как добавить слово:*\n\n" +
                    ...
                    "А если хотите добавить фразу и перевод, то введите ее через тире ('-') \n\n" +
                    "*Например:*\n" +
                    "`apple - яблоко`\n" +
    ...
    public String handleTextCommand(String text, long chatId) {
        ...
        if ("waiting_delete_word".equals(userStates.get(chatId))) {
            System.out.println("Ввеедено второе слово для удаления в словаре");
        ...
        return "Никакая команда не активирована";
    }
