 ...
 * вызывает метод отпарвки нашего запроса непосредственно ии
 */


public class StartYesButton {
    //наш  шедевро запрос
    private static final String PROMPT= "Напиши тест на 9 вопросов на проверку англиского языка: 3 вопроса на уровень c1-c2, 3 вопроса на уровень b1-b2," +
            "3 вопроса на уровень a1-a2. так же навешай баллы за ответы: на уровень c - 3 балла, на уровень b  - 2 балла," +
            "на уровень a - 1 балла. так же нужно относительно уровней делать в расброс задания, так же на каждый вопрос" +
