...
public class ScheduleGenerateTests {
    ...
    private String createPrompt(long userId) {
        ...
        return "Создай тест по английскому языку для изучения слов. \n" +
                ...
                "- Тест должен содержать 10 вопросов\n" +
                "- 4 вопроса должны быть на новые случайные английские слова\n" +
                "- 6 вопросов должны быть на слова из этого списка: " + priorityWordsString + "\n" +
                ...
                "\n" +
                "ФОРМАТ ОФОРМЛЕНИЯ:\n" +
                "- Четкое разделение вопросов и вариантов ответов\n" +
                "- Профессиональный, но дружелюбный тон\n" +
                "- Легко парсимая структура\n" +
                "\n" +
                "СТРУКТУРА ТЕСТА:\n" +
                "\n" +
                ...
                "- Использовать слова из предоставленного списка приоритетных слов\n" +
                ...
                "Ответ: B\n" +
                "Тип: НОВОЕ\n" +
                "Словo: stable - устойчивый, стабильный\n" +
                "\n" +
                "ТИПЫ ВОПРОСОВ:\n" +
